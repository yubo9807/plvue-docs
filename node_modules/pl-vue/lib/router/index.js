...
import { isString, isBrowser, customForEach, createId, deepClone, isFunction, len } from '../utils';
import { h, Fragment, renderToString, onMounted, createElementFragment, onUnmounted, createHTML } from '../vdom';
...
function BrowserRouter(props) {
  ...
  return h(Fragment, null, () => h(Comp.value, {
    ...attrs
  }));
}
...
function resultReplace(replaceStr, Comp, attrs) {
  const string = renderToString(h(Comp, {
    ...attrs
  }));
...
export { Helmet, Link, Route, Router, initRouter, useRoute, useRouter };

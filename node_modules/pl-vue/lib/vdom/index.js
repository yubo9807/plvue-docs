import { isStrictObject, isString, isFunction, isClass, customForEach, len, CustomWeakMap, isObject, objectAssign, nextTick, isArray, printWarn, customFindIndex, binarySearch, isEquals } from '../utils';
...
export { Fragment, Static, Structure, createApp, defineExpose, h, onBeforeMount, onBeforeUnmount, onMounted, onUnmounted, render, renderToString, useComponent };
